...
router.get("/:role",middleware.isLoggedIn,(req,res) => {
    Application.find({
        ...
        if(err){
            ...
            res.render("application/index", {currentUser: req.user , applications: allApplications});
        }
    })    
...
router.get("/:hostelid/warden",middleware.isLoggedIn,(req,res) => {
    Application.find({
        ...
        if(err){
            ...
            // console.log(allApplications);
            res.render("application/hostelwarden", {currentUser: req.user , applications: allApplications});
        }
    })
...
router.get("/:role/history",middleware.isLoggedIn , (req,res) => {
    Application.find({
        ...
        if(err){
            ...
            // console.log(allApplications);
            res.render("application/history", {currentUser: req.user , applications: allApplications});
        }
    });
});
