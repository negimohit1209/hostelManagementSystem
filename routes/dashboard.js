    ...
    if(req.user.role === 'admin'){
        Hostel.find(
            ...
            if(err){
                ...
                res.render("hostel/index", { hostels: allHostels , currentUser: req.user});
            }
        })
    }
...
router.post('/hostels/:hostelid/apply/:role/:userid', middleware.isLoggedIn,(req,res)=> {
        ...
        if(err){
            ...
            User.find({
                ...
                if(err){
                    ...
                    res.render("hostel/boarder" , {currentUser: req.user, boarder: allUsers})
                }
            })
        }
    })
